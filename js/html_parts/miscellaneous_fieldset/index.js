...
} from '../../components/checkboxComponent';
...
const _appendFieldset = function (targetElement) {
  const fieldset = GetFieldsetComponent(_FIELDSET_NAME, 'Miscellaneous');

  const checkboxContainer = fieldset.querySelector(
    `.${SelectorCssClasses.COLLAPSIBLE_CONTENT}`,
  );
